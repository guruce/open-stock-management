...
/**
 * PurchasePayment form base class.
 *
 * @method PurchasePayment getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePurchasePaymentForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('purchase_payment[%s]');
